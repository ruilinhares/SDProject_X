...
public abstract class Eleicao implements Serializable {
    ...
    public abstract Departamento getDep();
    /**
    ...
    public abstract ArrayList<ListaCandidata> getListasE();
    public abstract ArrayList<ListaCandidata> getListasF();
    public abstract ArrayList<ListaCandidata> getListasD();
    public abstract ArrayList<Voto> getVotosE();
    public abstract ArrayList<Voto> getVotosF();
    public abstract ArrayList<Voto> getVotosD();
    ...
    public abstract boolean isNucleo();
    
    public abstract ArrayList<String> getCandidatos();
